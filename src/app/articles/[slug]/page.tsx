...
export default async function ArticleDetailPage({ params }: ArticleDetailPageProps) {
  // Support both Promise and direct object for params (Next.js 14+)
  ...
  return (
    <article className="max-w-3xl mx-auto bg-white/95 p-0 rounded-3xl shadow-2xl mt-12 overflow-hidden border border-blue-100 font-sans">
      <div className="bg-linear-to-r from-primary to-blue-900 px-10 py-8">
      ...
      <div className="px-10 py-10 bg-linear-to-b from-white via-blue-50/60 to-white">
